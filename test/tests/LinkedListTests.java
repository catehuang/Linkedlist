...
class LinkedListTests {
	...
	/**
	 * Tests inserting a node at invalid index (greater than the max index and the size of linked list)
	 */
	@Test
	void testInsertNodeAtOutOfIndex() {
		this.linkedList.append("a");
		this.linkedList.append("b");
		this.linkedList.append("c");
		this.linkedList.append("d");
		 ...
		 * a -> b -> c -> d
		 */
		int index = this.linkedList.size();
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.insert("e", index + 2));	
	}
	
	/**
	 * Tests inserting a node at invalid index (-1)
	 */
	@Test
	void testInsertNodeAtNegativeIndex() {
		this.linkedList.append("a");
		this.linkedList.append("b");
		this.linkedList.append("c");
		this.linkedList.append("d");
	...
	/**
	 * Tests inserting at the (max index + 1)
	 */
	@Test
	void testInsertNodeIntoTheNextOfTheMaxIndex() {
		this.linkedList.append("a");
		this.linkedList.append("b");
		this.linkedList.append("c");
		this.linkedList.append("d");
		
		this.linkedList.insert("e", this.linkedList.size());	// actually it uses append
		...
		assertFalse(this.linkedList.isEmpty());
		assertEquals(5, this.linkedList.size());
		assertEquals("e", this.linkedList.retrieve(this.linkedList.size() - 1));
		assertEquals("d", this.linkedList.retrieve(this.linkedList.size() - 2));
		assertEquals("c", this.linkedList.retrieve(this.linkedList.size() - 3));
	}
	
	
	/**
	 * Tests inserting at the max index of the linked list and at the max index + 1
	 */
	@Test
	void testInsertNodeAtTheMaxIndex() {
		this.linkedList.append("a");
		this.linkedList.append("b");
		this.linkedList.append("c");
		this.linkedList.append("d");
		
		this.linkedList.insert("e", this.linkedList.size() - 1);	// insert into the last index
		/**
		 * Linked list should now be:
		 * 
		 * a -> b -> c -> e -> d
		 */
		assertEquals(5, this.linkedList.size());
		assertEquals("d", this.linkedList.retrieve(this.linkedList.size() - 1));
		assertEquals("e", this.linkedList.retrieve(this.linkedList.size() - 2));
		assertEquals("c", this.linkedList.retrieve(this.linkedList.size() - 3));
	}
		
	/**
	 * Tests deleting the first node in the linked list
	 */
	@Test
	...
	/**
	 * Tests deleting the last node in the linked list
	 */
	@Test
	void testDeleteLastNode() {
		...
		this.linkedList.delete(this.linkedList.size() - 1);
		assertEquals(2, this.linkedList.size());
		assertEquals("a", this.linkedList.retrieve(0));
		assertEquals("b", this.linkedList.retrieve(1));
	}
	...
	/**
	 * Tests the circumstance that there is no matched node
	 */
	@Test
	void testFindNoMatchedNode() {
		this.linkedList.append("a");
		this.linkedList.append("b");
		this.linkedList.append("c");
		assertEquals(3, this.linkedList.size());
		...
		assertFalse(this.linkedList.contains("d"));
