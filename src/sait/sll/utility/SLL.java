...
/**
 * Implement the interface LinkedListADT and provide all methods of interface.
 *
 */
public class SLL implements LinkedListADT, Serializable {
	...
	/**
	 * Test the linked list is empty or not
	 */
	@Override
	...
	public Object retrieve(int index) throws IndexOutOfBoundsException {
		if(isEmpty()) {
			...
			if (index + 1 > size || index < 0) {	// invalid index
				throw new IndexOutOfBoundsException();
			} 
			else {				// valid index
				Node temp = head;
